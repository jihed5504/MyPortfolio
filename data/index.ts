...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Managed and executed a client-specific mobile app development project from conceptualization to deployment on app stores, focusing on both Android and iOS platforms.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },
  {
